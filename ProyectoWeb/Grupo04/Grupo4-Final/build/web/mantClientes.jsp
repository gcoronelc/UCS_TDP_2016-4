...
<html>
  <head>
    ...
    <script type="text/javascript">
		...
		/* Funciona en FireFox Chrome  IE8 */
		popup = window.open("popup-window.jsp?company=VentanaPopup",
						"height=350,width=250,toolbar=no,menubar=no,scrollbars=yes");
          ...
          <table>
            <tr>
              ...
              <td rowspan="2" style="vertical-align: bottom;">
                ...
                <input type="button" name="btnNuevo" value="Nuevo" onclick="NuevoPopup();" />
