        ...
        <div id="page-wrapper">
            <div class="row">
                ...
                <img src="Arch/Img/logo.png" alt="" class="img-rounded img-responsive pull-right"/>
                    <h1 class="page-header">Consulta de Productos</h1>
                </div>
                <div class="egcc_work">
        
        <form method="post" action="/CompuStore-Web/ProductoController">                               
          <table>
            <tr>
            ...
            <tr>
              <td><input type="text" name="nombre" size="100" value="${requestScope.bean.nombre}"/></td>
