                                    ...
                                    <article>
                                        ...
                                        <form method="post" action="ProductoController">
                                          <table>
                                            ...
                                            <tr>
                                              <td><input type="text" name="nombre" size="50" value="${requestScope.bean.nombre}"/></td>
                                            </tr>
                                          </table>
                                        </form>
                                        <!-- Resultado -->
                                          ...
                                          <table id="tabladatos">
                                            ...
                                            <c:forEach items="${requestScope.lista}" var="r">
                                              <tr id="tr2">
                                                ...
                                                <td id="th2">${r.tipo}</td>
                                                <td id="th2">${r.precio}</td>
                                                <td id="th2">${r.stock}</td>
                                                <td id="th2">${r.stock_min}</td>
                                              </tr>
                                            </c:forEach>
                                          </table>
                                            </article>
