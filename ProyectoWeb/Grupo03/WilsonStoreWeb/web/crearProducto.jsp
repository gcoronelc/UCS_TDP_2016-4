                                    ...
                                    <article>
                                        ...
                                        <form method="post" action="ProductoController">
                                          <table>
                                            <tr>
                                              <td>TIPO</td>
                                              <td>&nbsp;<select name="tp_producto">
                                                <option value="0">Seleccionar Tipo</option>
                                                <c:forEach items="${requestScope.tipos}" var="r">
                                            ...
                                            <tr>
                                              <td>PRECIO</td>
                                              <td><input type="text" name="precio" size="8" value="${requestScope.bean.precio}"/></td>
                                            </tr>
                                            <tr>
                                              <td>DESCRIPCION</td>
                                              <td><input type="text" name="descripcion" size="50" value="${requestScope.bean.descripcion}"/></td>
                                            </tr>
                                            <tr>
                                              <td>STOCK</td>
                                              <td><input type="text" name="stock" size="50" value="${requestScope.bean.stock}"/></td>
                                            </tr>
                                            <tr>
                                              <td>STOCK MINIMO</td>
                                              <td><input type="text" name="stock_min" size="10" value="${requestScope.bean.stock_min}"/></td>
                                            </tr>
                                            <TR>
