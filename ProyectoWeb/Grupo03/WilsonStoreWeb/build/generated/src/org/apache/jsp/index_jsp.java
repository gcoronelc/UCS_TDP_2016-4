...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"icon-bar\"></span>\n");
      out.write("\t\t\t\t\t\t\t\t</button>\n");
      out.write("\t\t\t\t\t\t\t\t<a href=\"index.jsp\" class=\"navbar-brand\">Mi Proyecto</a>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"collapse navbar-collapse\" id=\"acolapsar\">\n");
      out.write("\t\t\t\t\t\t\t\t<ul class=\"nav navbar-nav\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<li><a href=\"main.jsp\"><span class=\"glyphicon glyphicon-home\"></span> Inicio</a></li>\n");
      out.write("\t\t\t\t\t\t\t\t\t<li><a href=\"mantCliente.jsp\"><span class=\"glyphicon glyphicon-cog\"></span> Clientes</a></li>\n");
      out.write("\t\t\t\t\t\t\t\t\t<li><a href=\"mantProducto.jsp\"><span class=\"glyphicon glyphicon-cloud\"></span> Productos</a></li>\n");
      out.write("\t\t\t\t\t\t\t\t\t");
      out.write("\n");
