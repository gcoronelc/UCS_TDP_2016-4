...
go
insert into tp_usuario(descripcion) values('admin')
insert into tp_usuario(descripcion) values('user')
go
create table usuario(
id integer identity(1,1)not null primary key,
usuario varchar(20) unique,
contra varbinary(8000),
nombre varchar(100),
tp_user integer references tp_usuario(id))
go
insert into usuario(usuario,contra,nombre,tp_user) values('admin',PWDENCRYPT('admin'),'admin-jcpr',1)
go
